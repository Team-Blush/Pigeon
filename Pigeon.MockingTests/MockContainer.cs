namespace Pigeon.MockingTests
{
    ...
    {
        //TODO: The Mocking test could be time demanding, because of the all aditional setup that we should make. Another thing is that we should mock users, which will affect the source code in the Controllers and that could misslead the other memers of the team, that is why the mocking test are considered as optional.
